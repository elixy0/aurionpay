...
export function FeatureGrid() {
  const features = [
    ...
    {
      icon: Coins,
      title: 'WHSK + Stablecoin Support',
      description: 'Accept WHSK, USDC, USDT and other assets with seamless multi-currency support.',
    ...
    {
      icon: Network,
      title: 'Built on Hashkey',
      description: 'Built on Hashkey for native interoperability with the entire Hashkey ecosystem.',
